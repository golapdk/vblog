!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).GhostContentAPI = t()
}(this, function() {
    "use strict";
    var e = function(e, t) {
        return function() {
    ...
    var f = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]
      , d = a.isStandardBrowserEnv() ? function() {
    ...
    var l = function(e) {
        for (var t, n, r = String(e), o = "", i = 0, s = p; r.charAt(0 | i) || (s = "=",
        i % 1); o += s.charAt(63 & t >> 8 - i % 1 * 8)) {
      ...
      , g = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || l
      , y = function(e) {
        return new Promise(function(t, n) {
            var r = e.data
              , o = e.headers;
            a.isFormData(r) && delete o["Content-Type"];
            var i = new XMLHttpRequest
              , s = "onreadystatechange"
              , p = !1;
            if ("undefined" == typeof window || !window.XDomainRequest || "withCredentials"in i || d(e.url) || (i = new window.XDomainRequest,
            s = "onload",
            p = !0,
            ...
            i.timeout = e.timeout,
            i[s] = function() {
                if (i && (4 === i.readyState || p) && (0 !== i.status || i.responseURL && 0 === i.responseURL.indexOf("file:"))) {
                    var r, o, s, c, d, h = "getAllResponseHeaders"in i ? (r = i.getAllResponseHeaders(),
                    d = {},
                    r ? (a.forEach(r.split("\n"), function(e) {
                        if (c = e.indexOf(":"),
                        o = a.trim(e.substr(0, c)).toLowerCase(),
                        s = a.trim(e.substr(c + 1)),
                        o) {
                            if (d[o] && f.indexOf(o) >= 0)
                                return;
                            d[o] = "set-cookie" === o ? (d[o] ? d[o] : []).concat([s]) : d[o] ? d[o] + ", " + s : s
                        }
                    }),
                    d) : d) : null, l = {
            ...
            ,
            i.onerror = function() {
                n(u("Network Error", e, null, i)),
                i = null
            }
            ,
            i.ontimeout = function() {
                n(u("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", i)),
                i = null
            }
            ,
            a.isStandardBrowserEnv()) {
                var y = m
                  , w = (e.withCredentials || d(e.url)) && e.xsrfCookieName ? y.read(e.xsrfCookieName) : void 0;
                w && (o[e.xsrfHeaderName] = w)
            }
    ...
    var C, E = {
        adapter: ("undefined" != typeof XMLHttpRequest ? C = y : "undefined" != typeof process && (C = y),
        C),
        transformRequest: [function(e, t) {
            ...
            a.isFormData(e) || a.isArrayBuffer(e) || a.isBuffer(e) || a.isStream(e) || a.isFile(e) || a.isBlob(e) ? e : a.isArrayBufferView(e) ? e.buffer : a.isURLSearchParams(e) ? (v(t, "application/x-www-form-urlencoded;charset=utf-8"),
            e.toString()) : a.isObject(e) ? (v(t, "application/json;charset=utf-8"),
            JSON.stringify(e)) : e
        }
        ],
    ...
    var P = function(e) {
        ...
        (e.adapter || b.adapter)(e).then(function(t) {
            return x(e),
    ...
    function U(t) {
        var n = new k(t)
          , r = e(k.prototype.request, n);
        return a.extend(r, k.prototype, n),
        a.extend(r, n),
        r
    }
    var L = U(b);
    ...
    var F = N;
    const $ = ["v2"];
    return function e({host: t, ghostPath: n="ghost", version: r, key: o}) {
        ...
        const i = ["posts", "authors", "tags", "pages", "settings"].reduce((e,t)=>Object.assign(e, {
            [t]: {
                read: function(e, n={}, r) {
                    if (!e)
                    ...
                    return s(t, o, e.id || `slug/${e.slug}`, r)
                },
                browse: function(e={}, n) {
                    return s(t, e, null, n)
                }
        ...
        return delete i.settings.read,
        i;
        function s(e, i, s, a=null) {
            if (!a && !o)
            ...
            delete i.id;
            const u = a ? {
                Authorization: `GhostMembers ${a}`
            } : void 0;
            return F.get(`${t}/${n}/api/${r}/content/${e}/${s ? s + "/" : ""}`, {
                params: Object.assign({
                    key: o
                }, i),
                paramsSerializer: e=>Object.keys(e).reduce((t,n)=>{
                    const r = encodeURIComponent([].concat(e[n]).join(","));
                    return t.concat(`${n}=${r}`)
                }
                , []).join("&"),
                headers: u
